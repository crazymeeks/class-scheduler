...
<div class="page-container">
	...
	@include('scheduler.admin.nav.sidebar-left')
...
<script src="{{ global_plugins('/jquery-ui/jquery-ui.min.js') }}" type="text/javascript"></script>
<script src="{{ global_plugins('/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
<script src="{{ global_plugins('/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js') }}" type="text/javascript"></script>
<script src="{{ global_plugins('/jquery-slimscroll/jquery.slimscroll.min.js') }}" type="text/javascript"></script>
